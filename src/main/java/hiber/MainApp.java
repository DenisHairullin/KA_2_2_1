...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      userService.add(new User("User3", "Lastname3", "user3@mail.ru", new Car("Hyundai", 3)));
      ...
      User carUser = userService.getUserByCar("Honda", 2);
      ...
      System.out.println("Car = " + carUser.getCar());
      System.out.println();
